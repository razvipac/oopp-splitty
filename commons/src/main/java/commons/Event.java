...
public class Event {
     ...
     */
    private static List<Participant> basicGetParticipants
    (List<Participant> allParticipants, Event event) {
     ...
     */
    public Set<Participant> getDebtorsWithinExpense
    (List<Participant> allParticipants, Expense expense) {
